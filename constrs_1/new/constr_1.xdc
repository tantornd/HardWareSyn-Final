...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {RsTx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RsTx}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {RsRx_2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RsRx_2}]
##Sch name = JB3
...
set_property PACKAGE_PIN A18 [get_ports RsTx_2]						
	set_property IOSTANDARD LVCMOS33 [get_ports RsTx_2]
